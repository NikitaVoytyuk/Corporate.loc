        ...
        <div id="header" class="group">
            ...
            <div class="group inner">
                ...
                <div id="sidebar-header" class="group">
                    ...
                    @else
                        <li class="auth-menu">
                            <p href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><h4> Добро пожаловать
                                {{ Auth::user()->name }}</h4> <span class="caret"></span>
                            </p>

                            <ul class="dropdown-menu" role="menu">
                                <li style="list-style-type: none"><a href="{{ url('/logout') }}"><i class="fa fa-btn fa-sign-out"></i>Logout</a></li>
                            </ul>
                        </li>
                    @endif
                </div>
                ...
                <!-- START PAGE META -->
                    <div id="page-meta">
                        <div class="inner group">
                            <h3>Добро пожаловать на страницу наших портфолио</h3>
                            <h4>... надеюсь вам понравятся наши работы!</h4>
                        </div>
                    </div>
                    <!-- END PAGE META -->
            @endif
